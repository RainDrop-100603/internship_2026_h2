...
SAP BTP Trial 계정을 연결하여 ABAP Agent를 만들기 위한 프로젝트입니다.

## 문서 지도

| 문서 | 내용 |
|---|---|
| [1_사전공부/README.md](1_사전공부/README.md) | SAP BTP·ABAP 학습 자료 링크와 학습 순서 |
...
- `docs/` - 프로젝트 문서 (전제, 세팅 가이드, 조사 기록)
- `1_사전공부/` - SAP BTP, ABAP 관련 사전 학습 자료
